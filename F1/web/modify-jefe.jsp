...
<html>
    ...
    <body>
        ...
        <table class="table table-striped">
            ...
            <form method="get" action="editar-jefe.jsp">
                <tr>
                    <td>

                        <label name="CodJef" value="<%=request.getParameter("CodJef")%>">
                            <label value="CodJef"><%=request.getParameter("CodJef")%></label>
                    </td>
                    <td>

                        <input type="String" name="NomJef"  value="<%=request.getParameter("NomJef")%>">

                    </td>
                    <td>

                        <input type="String" name="ApeJef" value="<%=request.getParameter("ApeJef")%>">
