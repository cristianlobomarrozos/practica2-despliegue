...
s.execute("UPDATE Jefe set NomJef='"+request.getParameter("NomJef")+"', ApeJef='"+request.getParameter("ApeJef") + "', CodEqui=" + request.getParameter("CodEqui") + " WHERE CodJef=" + request.getParameter("CodJef"));
    conexion.close();
