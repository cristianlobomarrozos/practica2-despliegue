...
<html>
    ...
    <body>
        ...
        <table class="table table-striped">
            ...
            <form method="get" action="editar-equipo.jsp">
                <tr>
                    <td>

                        <input type="int" name="CodEqui" value="<%= request.getParameter("CodEqui") %>">

                    </td>
                    <td>

                        <input type="String" name="NomEqui" value="<%= request.getParameter("NomEqui") %>">

                    </td>
                    <td>

                        <input type="int" name="Campeonatos" value="<%= request.getParameter("Campeonatos") %>">

                    </td>

                    <td>

<!--<span><%= request.getParameter("CodJef") %></span>-->
                        <%
            ...
            <%
                    ...
                    ResultSet listado = s.executeQuery ("SELECT E.CodEqui, E.NomEqui,E.Campeonatos, J.ApeJef FROM Equipo E join Jefe J on (E.CodEqui=J.CodEqui) order by Campeonatos desc");
